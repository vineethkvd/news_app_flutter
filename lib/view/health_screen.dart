  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (articlesListViewModelController == null ||
          articlesListViewModelController.articlesHealth.isEmpty) {
        return Center(
          ...
          child: Center(
            child: SizedBox(
              ...
              child: Swiper(
                ...
                autoplay: false,
                itemCount:
                articlesListViewModelController.articlesHealth.length,
                itemBuilder: (context, index) {
                  final article =
                  articlesListViewModelController.articlesHealth[index];
                  return Card(
                    elevation: 5,
                    child: ClipRRect(
