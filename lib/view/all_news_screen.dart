  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (articlesListViewModelController == null ||
          articlesListViewModelController.articlesAll.isEmpty) {
        return Center(
          ...
          child: Center(
            child: SizedBox(
              ...
              child: Swiper(
                ...
                autoplay: false,
                itemCount:
                articlesListViewModelController.articlesAll.length,
                itemBuilder: (context, index) {
                  final article =
                  articlesListViewModelController.articlesAll[index];
                  return Card(
                    elevation: 5,
                    child: ClipRRect(
