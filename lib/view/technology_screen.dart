  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (articlesListViewModelController == null ||
          articlesListViewModelController.articlesTechnology.isEmpty) {
        return Center(
          ...
          child: Center(
            child: SizedBox(
              ...
              child: Swiper(
                ...
                autoplay: false,
                itemCount:
                articlesListViewModelController.articlesTechnology.length,
                itemBuilder: (context, index) {
                  final article =
                  articlesListViewModelController.articlesTechnology[index];
                  return Card(
                    elevation: 5,
                    child: ClipRRect(
