  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (articlesListViewModelController == null ||
          articlesListViewModelController.articlesScience.isEmpty) {
        return Center(
          ...
          child: Center(
            child: SizedBox(
              ...
              child: Swiper(
                ...
                autoplay: false,
                itemCount:
                articlesListViewModelController.articlesScience.length,
                itemBuilder: (context, index) {
                  final article =
                  articlesListViewModelController.articlesScience[index];
                  return Card(
                    elevation: 5,
                    child: ClipRRect(
